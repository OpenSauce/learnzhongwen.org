...
```sh
git clone https://github.com/nickjj/docker-django-example learnzhongwen
cd learnzhongwen
...
The app is named `learnzhongwen` right now but chances are your app will be a different
name. Since the app is already created we'll need to do a find / replace on a
few variants of the string "learnzhongwen" and update a few Docker related resources.
